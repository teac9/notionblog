// 注: process.env.XX是Vercel的环境变量，配置方式：https://docs.tangly1024.com/article/how-to-config-notion-next#c4768010ae7d44609b744e79e2f9959a
...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '看万山红遍，层林尽染；漫江碧透，百舸争流。', // 作者简介
